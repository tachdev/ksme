...
<div class="col-lg-12 col-xs-12 no-padding" >
          <div class="col-lg-12 col-xs-12 no-padding">
          	<div class="col-lg-12 col-sm-3 col-xs-12 pull-right create-event-btn-wrapper no-padding">
            		<a href="<?php echo url('create_event'); ?>" class="btn-round create-event-btn btn btn-danger btn-xs col-lg-2 col-xs-12 btn-md pull-right mg-r-sm"> Create Event</a> 
        	</div> 
	            ...
	            <div class="panel">
		          ...
		          <?php for ($i=1; $i < 16 ; $i++) { ?>
					...
					<div class="panel-body col-lg-3 event-block">
					    ...
					    <div style="font-size:11px;font-weight:normal">Invite by <strong>Mr. Sai Man</strong></div>                        		    
					</div>
