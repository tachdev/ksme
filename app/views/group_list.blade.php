...
<div class="col-lg-12 col-xs-12 no-padding" >
	<h4>
        <a href="#"><strong>Real Estate Agency</strong></a>
    </h4>
	<div class="panel">
...
<script type="text/javascript">
	$(".scroll").niceScroll({styler:"fb",cursorcolor:"#65cea7", cursorwidth: '6', cursorborderradius: '0px', background: '#424f63', spacebarenabled:false, cursorborder: '0',  zindex: '1000'});
</script>
